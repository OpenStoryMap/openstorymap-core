/**
 * https://codeorum.com/tutorials/simple-image-popup-effect-with-vanilla-js-and-css-animation
 **/
export default function initImagePopup(e: Event) {
  var image = e.target as HTMLImageElement; // get current clicked image
